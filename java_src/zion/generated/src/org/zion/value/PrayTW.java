...
public class PrayTW extends BaseObject implements Serializable {
    ...
    /** full constructor */
    public PrayTW(String descriptionUrl, String latitude, String longitude, Integer zoom, UploadedFile map, UploadedFile photo1, UploadedFile photo2, UploadedFile photo3, MiscCode area) {
