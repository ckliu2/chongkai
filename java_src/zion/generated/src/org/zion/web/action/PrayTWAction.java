...
public class PrayTWAction extends CommonActionSupport
{
    ...
    public void setGenericManager(PrayTWManager m)
    {
        super.setGenericManager(m);
    }

    public PrayTWManager getGenericManager()
    {
        return (PrayTWManager) super.getGenericManager();
    }
    ...
    public List<MiscCode> getAreaList()
    {
        return super.getAppPropertyList("prayTW.area");
    }
