...
public class PrayStreetAction extends CommonActionSupport
{
    ...
    public void setGenericManager(PrayStreetManager m)
    {
        super.setGenericManager(m);
    }

    public PrayStreetManager getGenericManager()
    {
        return (PrayStreetManager) super.getGenericManager();
    }
    ...
    public String copy()
    {
        if (selectedPrayStreetIds != null && selectedPrayStreetIds.length > 0) {
            PrayStreet obj = getGenericManager().getPrayStreetById(selectedPrayStreetIds[0]);
            obj.setId(null);
            prayStreet = obj;
        }
        beanToForm();
    ...
    {
        return getGenericManager().getPrayStreetList();
    }
