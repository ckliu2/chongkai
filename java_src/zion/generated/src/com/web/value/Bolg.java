...
public class Bolg extends BaseObject implements Serializable {
    ...
    /** full constructor */
    public Bolg(String name, String link, String content, String memo, Integer seqNo, Boolean status, Date beginDate, Date endDate, Date lastModifiedDate, Date createdDate, Member lastModifiedUser, Member createdUser, UploadedFile file, UploadedFile photo, com.web.value.BolgClass bolgClass, AppProperty linkType) {
        this.name = name;
        this.link = link;
