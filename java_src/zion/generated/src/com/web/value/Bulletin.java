...
public class Bulletin extends BaseObject implements Serializable {
    ...
    /** full constructor */
    public Bulletin(Date bulletinDate, String subject, String title, String description, String placeDesc, String timeDesc, String speaker, String flv, String worshipFlv, Boolean status, Date lastModifiedDate, Date createdDate, Member lastModifiedUser, Member createdUser, AppProperty bulletinType, UploadedFile file, UploadedFile voice, UploadedFile vedio, UploadedFile frontcover) {
    ...
    /** minimal constructor */
    public Bulletin(Date bulletinDate, String subject, Date lastModifiedDate, Date createdDate, Member lastModifiedUser, Member createdUser, AppProperty bulletinType) {
        this.bulletinDate = bulletinDate;
        this.subject = subject;
        this.lastModifiedDate = lastModifiedDate;
        this.createdDate = createdDate;
    ...
    public void setFileFileName(String val) {
        this.fileFileName = val;
    }
    ...
    public String toString() {
        return new ToStringBuilder(this)
            ...
            .append("flv", getFlv())
            .append("worshipFlv", getWorshipFlv())
