...
public class MemberManagerImpl extends CommonManagerImpl implements MemberManager
{
    ...
    public Long[] getIdsFromGradeList(List<Grade> lst)
    {
        return getGenericDAO().getIdsFromGradeList(lst);
    }

    public List<Grade> getGradeListByIds(Long[] ids)
    {
        return getGenericDAO().getGradeListByIds(ids);
    }

    public Long[] getIdsFromTeamList(List<Team> lst)
    {
        return getGenericDAO().getIdsFromTeamList(lst);
    }

    public List<Team> getTeamListByIds(Long[] ids)
    {
