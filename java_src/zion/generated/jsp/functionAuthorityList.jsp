...
<table border="0" cellspacing="1" class="cContentTable">
      ...
      <tr class="cActionButtonLine">
        ...
        <ww:if test="recordEditable == true">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;<button onclick="myCheckSubmitCopy('form1', <ww:property value="functionAuthorityList.size()"/>, 'selectedFunctionAuthorityId', 'copyFunctionAuthority.html', '<fmt:message key="common.mustSelectOne"/>', '<fmt:message key="common.mustSelectOnlyOne"/>')" class="cButton"><fmt:message key="common.copy"/></button>
        </ww:if>
        <ww:else>
...
<display:table name="functionAuthorityList" class="list" cellspacing="1" requestURI="" id="row" export="false" pagesize="${GLOBAL_pagesize}" sort="list">
    ...
    <display:column titleKey="common.select">
        <input type="checkbox" id="selectedFunctionAuthorityId_<c:out value="${count}"/>" name="selectedFunctionAuthorityId" value="<c:out value="${row.id}"/>">
    </display:column>
    <display:column property="editable" sortable="true" titleKey="functionAuthority.editable" style="text-align:left" />
...
<form name="form1" action="saveFunctionAuthority.html">
    ...
    <select name="selectedFunctionAuthorityIds" multiple="true" style="display:none"></select>
</form>
