...
<ww:form name="clockForm" action="saveClock" method="POST">
  ...
  <table border="0" cellspacing="1" class="cContentTable">
    ...
    <tr><td class="cInputCaption"><fmt:message key="clock.seqNo"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
    ...
    <tr><td class="cInputCaption"><fmt:message key="clock.meno"/></td>
        <td class="cInputColumn">
