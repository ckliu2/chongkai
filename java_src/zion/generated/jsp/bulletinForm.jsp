...
<ww:form name="bulletinForm" action="saveBulletin" method="POST" enctype="multipart/form-data">
  ...
  <table border="0" cellspacing="1" class="cContentTable">
    ...
    <tr><td class="cInputCaption"><fmt:message key="bulletin.description"/></td>
        <td class="cInputColumn">
            <ww:textarea name="bulletin.description" value="%{bulletin.description}" cssClass="cInputTextArea" cols="45" rows="12" />
        </td>
    </tr>
    ...
    <tr><td class="cInputCaption"><fmt:message key="bulletin.file"/></td>
        <td class="cInputColumn">
        <ww:if test="bulletin.file != null">
            <input type="checkbox" name="removeFile" onclick="if (this.checked == true) document.bulletinForm.fileFile.style.display='inline'; else document.bulletinForm.fileFile.style.display='none';" value="<ww:property value="bulletin.file.fileName"/>"><fmt:message key="common.delete"/>
            <a href="${ctx}/<fmt:message key="bulletin.uploadFile.relativeUrl"/>/<ww:property value="bulletin.id"/>/<ww:property value="bulletin.file.fileName"/>"><ww:property value="bulletin.file.fileName" /> (<ww:property value="bulletin.file.size" /> bytes)</a><br>
            ...
            <ww:hidden name="bulletin.fileId" value="${bulletin.file.id}"/>
            <ww:hidden name="bulletin.fileFileName" value="${bulletin.file.fileName}"/>
        </ww:if>
        <ww:else>
