...
<ww:form name="miscCodeForm" action="saveMiscCode" method="POST">
  <ww:hidden name="miscCode.id" value="${miscCode.id}"/>
  <table border="0" cellspacing="1" class="cContentTable">
    ...
    <tr><td class="cInputCaption"><fmt:message key="miscCode.seqNo"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
            <ww:textfield name="miscCode.seqNo" value="%{miscCode.seqNo}" cssClass="cInputTextFieldTiny" /><span class="cInputValidationError"><ww:property value="showHtmlErrorMessage('miscCode.seqNo')"/></span>
        </td>
    </tr>
