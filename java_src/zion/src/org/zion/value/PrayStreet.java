...
public class PrayStreet extends BaseObject implements Serializable {
    ...
    /** full constructor */
    public PrayStreet(String name, UploadedFile map, UploadedFile photo1,
	    UploadedFile photo2, UploadedFile photo3,
	    org.zion.value.PrayTW praytw) {
	this.name = name;
	this.map = map;
	this.photo1 = photo1;
	this.photo2 = photo2;
	...
	return new ToStringBuilder(this).append("name", getName())
		...
		.append("praytw", getPraytw()).toString();
    }
