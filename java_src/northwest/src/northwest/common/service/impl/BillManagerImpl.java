...
public class BillManagerImpl extends CommonManagerImpl implements BillManager
{
    ...
    /*
    public  List<Bill> getBillListByCondition(int condition,Customer customer,String billNo,int pageSize,int pageIndex,Group group,boolean state){
    	return getGenericDAO().getBillListByCondition(condition,customer,billNo,pageSize,pageIndex,group,state);
    }
    
    public  int getBillListByConditionCount(int condition,Customer customer,String billNo,Group group,boolean state){
    	return getGenericDAO().getBillListByConditionCount(condition,customer,billNo,group,state);
    }
    */
