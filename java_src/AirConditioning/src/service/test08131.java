...
public class test08131 {
	...
	static String OGWebService="http://140.129.140.153:99/OGWeb/OGWebService/OGWebService.asmx";
	
    public static void main(String[] args) {
    	setDevicePowerStatus("和平0201",false);
    	System.out.println("inquireDevicePowerStatus="+inquireDevicePowerStatus("和平0201"));
    }
