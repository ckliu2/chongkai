...
{ 
	...
	private boolean poweradmin;
    

        
    public SessionUser(Long id, String id2, String name, String picture, Boolean enabled, List role)
    {
        super();
        this.id = id;
        this.loginId = id2;
    ...
    public SessionUser(Long id, String id2, String name, String picture, Boolean enabled)
    {
        super();
        this.id = id;
        this.loginId = id2;
	...
	public void setPoweradmin(boolean poweradmin) {
