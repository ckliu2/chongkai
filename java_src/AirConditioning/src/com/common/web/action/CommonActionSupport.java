...
public abstract class CommonActionSupport extends BaseActionSupport
{
    ...
    public List<NameValue> getTemperatureList()
    {
    	List<NameValue> al = new ArrayList<NameValue>();
    	for(int i=19;i<=28;i++)
    	{
    	  al.add(new NameValue(i, String.valueOf(i)+"℃"));
    	}
        return al;
    }
  ...
  /**門禁機編號*/
    ...
    public List<NameValue> getLessonList()
    {
        List<NameValue> al = new ArrayList<NameValue>();
        for(int i=1;i<=17;i++){
           al.add(new NameValue(i,"第"+String.valueOf(i)+"節"));
        }
        return al;
    }
