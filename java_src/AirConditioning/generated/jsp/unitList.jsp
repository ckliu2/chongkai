...
<table border="0" cellspacing="1" class="cContentTable">
      ...
      <tr class="cActionButtonLine">
        ...
        <ww:if test="recordEditable == true">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;<button onclick="myCheckSubmitCopy('form1', <ww:property value="unitList.size()"/>, 'selectedUnitId', 'copyUnit.html', '<fmt:message key="common.mustSelectOne"/>', '<fmt:message key="common.mustSelectOnlyOne"/>')" class="cButton"><fmt:message key="common.copy"/></button>
        </ww:if>
        <ww:else>
...
<display:table name="unitList" class="list" cellspacing="1" requestURI="" id="row" export="false" pagesize="${GLOBAL_pagesize}" sort="list">
    ...
    <display:column titleKey="common.select">
        <input type="checkbox" id="selectedUnitId_<c:out value="${count}"/>" name="selectedUnitId" value="<c:out value="${row.id}"/>">
    </display:column>
