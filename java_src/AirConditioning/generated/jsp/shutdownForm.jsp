...
<ww:form name="shutdownForm" action="saveShutdown" method="POST">
  ...
  <table border="0" cellspacing="1" class="cContentTable">
    ...
    <tr><td class="cInputCaption"><fmt:message key="shutdown.perc"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
            <ww:textfield name="shutdown.perc" value="%{shutdown.perc}" cssClass="cInputTextFieldTiny" /><span class="cInputValidationError"><ww:property value="showHtmlErrorMessage('shutdown.perc')"/></span>
        </td>
    </tr>
