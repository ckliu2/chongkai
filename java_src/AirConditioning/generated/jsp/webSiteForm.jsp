  ...
  <table border="0" cellspacing="1" class="cContentTable">
    ...
    <tr><td class="cInputCaption"><fmt:message key="webSite.code"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
            <ww:textfield name="webSite.code" value="%{webSite.code}" maxlength="20" cssClass="cInputTextFieldShort" /><span class="cInputValidationError"><ww:property value="showHtmlErrorMessage('webSite.code')"/></span>
        </td>
    </tr>
    ...
    <tr><td class="cInputCaption"><fmt:message key="webSite.seoTitle"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
    ...
    <tr><td class="cInputCaption"><fmt:message key="webSite.seoKeyword"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
    ...
    <tr><td class="cInputCaption"><fmt:message key="webSite.seoDesc"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
