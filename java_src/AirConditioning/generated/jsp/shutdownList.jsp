...
<display:table name="shutdownList" class="list" cellspacing="1" requestURI="" id="row" export="false" pagesize="${GLOBAL_pagesize}" sort="list">
    ...
    <display:column property="perc" sortable="true" titleKey="shutdown.perc" />
    ...
    <display:column property="evenlevel.caption_" sortable="true" titleKey="shutdown.evenlevel" style="text-align:left"/>
    ...
    <display:column titleKey="common.action">
        <ww:if test="recordEditable == true">
            ...
            <a href="#" onClick="javascript:return myConfirm('<fmt:message key="common.confirmDelete1"/><c:out value="${row.caption_}" /><fmt:message key="common.confirmDelete2"/>', 'form1', 'shutdown.id', '${row.id}')"><fmt:message key="common.delete"/></a>
        </ww:if>
        <ww:else>
