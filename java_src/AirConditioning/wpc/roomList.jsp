...
<display:table name="roomList" class="list" cellspacing="1" requestURI="" id="row" export="false" pagesize="${GLOBAL_pagesize}" sort="list">
    ...
    <display:column property="member.caption_" sortable="true" titleKey="room.member" style="text-align:left"/>
    <display:column property="building.caption_" sortable="true" titleKey="room.building" style="text-align:left"/>
