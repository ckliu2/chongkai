...
<ww:form name="buildingForm" action="saveBuilding" method="POST">
  ...
  <table border="0" cellspacing="1" class="cContentTable">
    ...
    <tr><td class="cInputCaption"><fmt:message key="building.member"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
            <ww:select name="building.memberId" 
               headerKey=""
            ...
            /><span class="cInputValidationError"><ww:property value="showHtmlErrorMessage('building.memberId')"/></span>
        </td>
    </tr>
