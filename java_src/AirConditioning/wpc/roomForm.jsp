...
<ww:form name="roomForm" action="saveRoom" method="POST">
  ...
  <table border="0" cellspacing="1" class="cContentTable">
    ...
    <tr><td class="cInputCaption"><fmt:message key="room.member"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
            <ww:select name="room.memberId" 
               headerKey=""
            ...
            /><span class="cInputValidationError"><ww:property value="showHtmlErrorMessage('room.memberId')"/></span>
        </td>
    </tr>

    <tr><td class="cInputCaption"><fmt:message key="room.building"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
