...
public class Menu extends BaseObject implements Serializable {
    ...
    /** full constructor */
    public Menu(String name, Integer seqNo, Boolean status, String content, String url, Date lastModifiedDate, Date createdDate, Member lastModifiedUser, Member createdUser) {
        this.name = name;
        this.seqNo = seqNo;
        this.status = status;
