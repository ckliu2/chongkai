...
public class SubMenu extends BaseObject implements Serializable {
    ...
    /** full constructor */
    public SubMenu(String name, Integer seqNo, Boolean status, String content, String url, Date lastModifiedDate, Date createdDate, com.web.value.Menu menu, Member lastModifiedUser, Member createdUser, AppProperty linkType) {
        this.name = name;
        this.seqNo = seqNo;
        this.status = status;
