...
<ww:form name="bolgClassForm" action="saveBolgClass" method="POST">
  ...
  <table border="0" cellspacing="1" class="cContentTable">
    ...
    <tr><td class="cInputCaption"><fmt:message key="bolgClass.name"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
            <ww:textfield name="bolgClass.name" value="%{bolgClass.name}" maxlength="20" cssClass="cInputTextFieldShort" /><span class="cInputValidationError"><ww:property value="showHtmlErrorMessage('bolgClass.name')"/></span>
        </td>
    </tr>
