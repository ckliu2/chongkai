...
<ww:form name="bolgForm" action="saveBolg" method="POST" enctype="multipart/form-data">
  ...
  <table border="0" cellspacing="1" class="cContentTable">
    ...
    <tr><td class="cInputCaption"><fmt:message key="bolg.title"/></td>
        <td class="cInputColumn">
            <ww:textfield name="bolg.title" value="%{bolg.title}" maxlength="0" cssClass="cInputTextField" />
        </td>
    </tr>
    ...
    <tr><td class="cInputCaption"><fmt:message key="bolg.myfile"/></td>
        <td class="cInputColumn">
