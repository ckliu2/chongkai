...
public interface CommonDAO extends BaseDAO {
    ...
    public abstract Member findMemberByEmailAndCellphone(String email,String cellphone);
    ...
    public abstract Member getMemberByIdNoAndBirthday(String idNo,
	    String brithday);
    ...
    public abstract int findAllMemberSize(String keyword, String departmentId,
	    int graduationYear, int pageSize, int pageIndex);

    public abstract List<Member> findAllMember(String keyword,
	    String departmentId, int graduationYear, int pageSize, int pageIndex);
