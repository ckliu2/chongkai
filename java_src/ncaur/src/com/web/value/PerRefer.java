...
public class PerRefer extends BaseObject implements Serializable {
    ...
    /** full constructor */
    public PerRefer(String name, String email, String phone, String cellphone, String memo, Boolean note, Date createdDate, AppProperty type, Member teacher) {
        this.name = name;
        this.email = email;
        this.phone = phone;
    ...
    /** minimal constructor */
    public PerRefer(String name, String email, String phone, String cellphone, Date createdDate, AppProperty type) {
        this.name = name;
        this.email = email;
        this.phone = phone;
        this.cellphone = cellphone;
