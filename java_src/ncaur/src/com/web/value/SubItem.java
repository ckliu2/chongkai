...
public class SubItem extends BaseObject implements Serializable {
    ...
    /** full constructor */
    public SubItem(String name, Integer seqNo, Boolean status, String content, Date lastModifiedDate, Date createdDate, Member lastModifiedUser, Member createdUser, com.web.value.SubMenu subMenu) {
        this.name = name;
        this.seqNo = seqNo;
        this.status = status;
