...
<table border="0" cellspacing="1" >
      ...
      <tr class="cActionButtonLine">
        <td>
           <button onclick="location.href='editCompanyCareers.html'" class="cButton"><fmt:message key="common.new"/></button>
...
<display:table name="companyCareersList" class="list" cellspacing="1" requestURI="" id="row" export="false" pagesize="${GLOBAL_pagesize}" sort="list">
    ...
    <display:column titleKey="common.action">
        <ww:if test="recordEditable == true">
            <a href="editCompanyCareers.html?careers.id=<c:out value="${row.id}"/>"><fmt:message key="common.edit"/></a>&nbsp;&nbsp;
        ...
        <ww:else>
           <a href="editCompanyCareers.html?careers.id=<c:out value="${row.id}"/>"><fmt:message key="common.view"/></a>&nbsp;&nbsp;
        </ww:else>
    </display:column>
...
<form name="form1" action="saveCompanyCareers.html">
