...
<ww:form name="careersForm" action="saveCompanyCareers" method="POST" onsubmit="onSubmit()">
  ...
  <table border="0" cellspacing="1" >
    ...
    <tr class="cActionButtonLine">
      <td colspan="2">
        <input type=button onclick="javascript:window.location='companyCareersList.html'" class="cButton" value="<fmt:message key="common.back"/>" >
   ...
   <!------------------------------------------------------------------------------------------------------------------------------------------------->
    ...
    <tr id="s14"><td class="cInputCaption1"><fmt:message key="common.pleaseSelect"/><fmt:message key="skill.skillClass"/></td>
        <td class="cInputColumn">     
           <ww:select id="allSkillClass" onchange="retrieveSecondOptions(this, 'allSkills', 'findSkills.html', 'key');"
                headerKey=""
                headerValue="%{getText('common.pleaseSelect')}..."
                list="skillClassList"
                listKey="id"
