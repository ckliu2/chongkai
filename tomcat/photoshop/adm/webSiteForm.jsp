...
<ww:form name="webSiteForm" action="saveWebSite" method="POST" onsubmit="onSubmit()">
  ...
  <table border="0" cellspacing="1" >
    ...
    <tr><td class="cInputCaption"><fmt:message key="webSite.htmlmain"/></td>
        <td class="cInputColumn">
            <ww:textfield name="webSite.htmlmain" value="%{webSite.htmlmain}" maxlength="100" cssClass="cInputTextFieldLong" />
        </td>
    </tr>
