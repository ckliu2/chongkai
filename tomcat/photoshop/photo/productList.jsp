...
<display:table name="productList" class="list" cellspacing="1" requestURI="" id="row" export="false" pagesize="${GLOBAL_pagesize}" sort="list">
    ...
    <display:column property="num" sortable="true" titleKey="product.num" />
    <display:column property="status" sortable="true" titleKey="product.status" style="text-align:left" />
