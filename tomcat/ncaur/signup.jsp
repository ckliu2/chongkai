...
<body onLoad="MM_preloadImages('image/course_07_roll.jpg')">
<div id="main">
        ...
        <div class="menu_down">
          <ul>
           <li><a href="about.html" ><span>有關總會 </span></a></li>                                
            ...
            <li><a href="calendar.html"><span class="onclick">都更課程</span></a></li>
...
<h1>${c.courseName}</hr1>
	<hr class="style4">
	  <div align="center">您好，歡迎您報名${c.courseName}，請選擇以下登入方式</div>
	</hr>
    ...
    <div align="center">
	   ...
	   <a href="userLogin1.do?course.id=${c.id}"  class="style1 style2">會員登入</a>
	   &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
	   
	   <a href="contact1.do?course.id=${c.id}"  class="style1 style2">非會員登入</a>  
