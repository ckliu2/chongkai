...
<ww:form name="linksForm" action="saveLinks.do" method="post" enctype="multipart/form-data">
  ...
  <table border="0" cellspacing="1" >
    ...
    <tr><td class="cInputCaption"><fmt:message key="links.name"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
            <ww:textfield name="links.name" value="%{links.name}" maxlength="20" cssClass="cInputTextFieldLong" /><span class="cInputValidationError"><ww:property value="showHtmlErrorMessage('links.name')"/></span>
        </td>
    </tr>

    <tr><td class="cInputCaption"><fmt:message key="links.link"/></td>
        <td class="cInputColumn">
            <ww:textfield name="links.link" value="%{links.link}" maxlength="50" cssClass="cInputTextFieldLong" />
        </td>
    </tr>
    ...
    <tr><td class="cInputCaption"><fmt:message key="common.photo"/></td>
        <td class="cInputColumn">
   ...
   <ww:if test="links.photo != null">
    <tr><td class="cInputCaption"></td>
        <td class="cInputColumn">
        <img border="0" src="<fmt:message key="links.uploadPhoto.relativeUrl"/>/${links.id}/${links.photo.fileName}" width="150" />
      </td>
    </tr>
    </ww:if>
