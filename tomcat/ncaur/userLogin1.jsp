...
<h1>會員登入<hr class="style5" ></h1>

<form action="loginx1.do?course.id=${course.id}" method="post">
...
<table width="600" border="0" class="form_table">
  <tbody>
    <tr>
      <td height="337" align="center" valign="middle" bgcolor="#F7F7F7"><table width="444" height="233" border="0" cellpadding="3" cellspacing="3">
        <tbody>
          <tr>
          ...
          <tr>
            <td width="102" height="31">手機號碼：</td>
            <td width="321"><input type="text" name="cellphone" id="cellphone" value=""/></td>
          </tr>
          <tr>
            <td valign="top">&nbsp;</td>
            <td valign="top"><input type="submit" name="submit" id="submit" value="會員登入" /> <input type="reset" name="reset" id="reset" value="清除資料" /> </td>
          </tr>
        </tbody>
      </table></td>
    </tr>
