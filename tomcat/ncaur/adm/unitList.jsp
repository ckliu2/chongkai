   ...
   <c:set var="count" value="${count+1}" />
      ...
      <tr class="cActionButtonLine">
        ...
        <ww:if test="recordEditable == true">
            ...
            &nbsp;&nbsp;&nbsp;&nbsp;<button onclick="myCheckSubmitCopy('form1', ${GLOBAL_pagesize}, 'selectedunitId', 'copyunit.do', '<fmt:message key="common.mustSelectOne"/>', '<fmt:message key="common.mustSelectOnlyOne"/>')" class="cButton"><fmt:message key="common.copy"/></button>
        </ww:if>
        <ww:else>
            <button onclick="location.href='editUnit.do'" DISABLED class="cButton"><fmt:message key="common.new"/></button><span class="cLabel2">(<fmt:message key="common.function.openPeriodExceed"/> )</span>
        </ww:else>
