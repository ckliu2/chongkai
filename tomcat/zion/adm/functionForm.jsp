  ...
  <table border="0" cellspacing="1" >
    ...
    <tr><td class="cInputCaption"><fmt:message key="function.seqNo"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
            <ww:textfield name="function.seqNo" value="%{function.seqNo}" cssClass="cInputTextFieldTiny" /><span class="cInputValidationError"><ww:property value="showdoErrorMessage('function.seqNo')"/></span>        </td>
    </tr>

    <tr><td class="cInputCaption"><fmt:message key="function.funKey"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
            <ww:textfield name="function.funKey" value="%{function.funKey}" maxlength="100" cssClass="cInputTextFieldLong" /><span class="cInputValidationError"><ww:property value="showdoErrorMessage('function.funKey')"/></span>        </td>
    </tr>

    <tr><td class="cInputCaption"><fmt:message key="function.funNameCh"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
            <ww:textfield name="function.funNameCh" value="%{function.funNameCh}" maxlength="100" cssClass="cInputTextFieldLong" /><span class="cInputValidationError"><ww:property value="showdoErrorMessage('function.funNameCh')"/></span>        </td>
    </tr>

    <tr><td class="cInputCaption"><fmt:message key="function.funNameEn"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
            <ww:textfield name="function.funNameEn" value="%{function.funNameEn}" maxlength="100" cssClass="cInputTextFieldLong" /><span class="cInputValidationError"><ww:property value="showdoErrorMessage('function.funNameEn')"/></span>        </td>
    </tr>

    <tr><td class="cInputCaption"><fmt:message key="function.funUrl"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
            <ww:textfield id="function_funUrl" name="function.funUrl" maxlength="100" value="%{function.funUrl}" cssClass="cInputTextFieldLong" /><span class="cInputValidationError"><ww:property value="showdoErrorMessage('function.funUrl')"/></span>        </td>
    </tr>
