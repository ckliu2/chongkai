  ...
  <table border="0" cellspacing="1" >
    ...
    <tr><td class="cInputCaption"><fmt:message key="webLog.clientIP"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
            <ww:textfield name="webLog.clientIP" value="%{webLog.clientIP}" maxlength="40" cssClass="cInputTextField" /><span class="cInputValidationError"><ww:property value="showdoErrorMessage('webLog.clientIP')"/></span>
        </td>
    </tr>
