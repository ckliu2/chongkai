  ...
  <table border="0" cellspacing="1" >
    ...
    <tr><td class="cInputCaption"><fmt:message key="webSite.name"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
            <ww:textfield name="webSite.name" value="%{webSite.name}" maxlength="40" cssClass="cInputTextField" /><span class="cInputValidationError"><ww:property value="showdoErrorMessage('webSite.name')"/></span>
        </td>
    </tr>

    <tr><td class="cInputCaption"><fmt:message key="webSite.title"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
            <ww:textfield name="webSite.title" value="%{webSite.title}" maxlength="40" cssClass="cInputTextField" /><span class="cInputValidationError"><ww:property value="showdoErrorMessage('webSite.title')"/></span>
        </td>
    </tr>
