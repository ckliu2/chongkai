    ...
    <table border="0" cellspacing="1" >
      ...
      <tr>
        ...
        <td class="cInputColumn">
            <ww:textfield name="appProperty.seqNo" value="%{appProperty.seqNo}" cssClass="cInputTextFieldShort" /><span class="cInputValidationError"><ww:property value="showdoErrorMessage('appProperty.seqNo')"/></span>
        </td>
      </tr>
      ...
      <tr>
        ...
        <td class="cInputColumn">
          <ww:textfield name="appProperty.valueTw" value="%{appProperty.valueTw}" maxlength="350" cssClass="cInputTextFieldLarge" /><span class="cInputValidationError"><ww:property value="showdoErrorMessage('appProperty.valueTw')"/></span>
        </td>
      </tr>
      <tr>
        <td class="cInputCaption"><fmt:message key="appProperty.valueUs"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
          <ww:textfield name="appProperty.valueUs" value="%{appProperty.valueUs}" maxlength="350" cssClass="cInputTextFieldLarge" /><span class="cInputValidationError"><ww:property value="showdoErrorMessage('appProperty.valueUs')"/></span>
        </td>
      </tr>
      <tr class="cActionButtonLine">
        <td colspan="2">
