  ...
  <table border="0" cellspacing="1" >
    ...
    <tr><td class="cInputCaption"><fmt:message key="group.groupKey"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
            <ww:textfield name="group.groupKey" value="%{group.groupKey}" maxlength="100" cssClass="cInputTextFieldLong" /><span class="cInputValidationError"><ww:property value="showdoErrorMessage('group.groupKey')"/></span>
        </td>
    </tr>

    <tr><td class="cInputCaption"><fmt:message key="group.groupNameCh"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
            <ww:textfield name="group.groupNameCh" value="%{group.groupNameCh}" maxlength="100" cssClass="cInputTextFieldLong" /><span class="cInputValidationError"><ww:property value="showdoErrorMessage('group.groupNameCh')"/></span>
        </td>
    </tr>

    <tr><td class="cInputCaption"><fmt:message key="group.groupNameEn"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
            <ww:textfield name="group.groupNameEn" value="%{group.groupNameEn}" maxlength="100" cssClass="cInputTextFieldLong" /><span class="cInputValidationError"><ww:property value="showdoErrorMessage('group.groupNameEn')"/></span>
        </td>
    </tr>
