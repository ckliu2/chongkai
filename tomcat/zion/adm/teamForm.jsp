  ...
  <table border="0" cellspacing="1" >
    ...
    <tr><td class="cInputCaption"><fmt:message key="team.name"/><span class="cRequired">*</span></td>
        <td class="cInputColumn">
            <ww:textfield name="team.name" value="%{team.name}" maxlength="100" cssClass="cInputTextFieldLong" /><span class="cInputValidationError"><ww:property value="showdoErrorMessage('team.name')"/></span>
        </td>
    </tr>
